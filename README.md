...
## 📢 News
* **[2026-01-26]** The paper is accepted by **ICLR 2026**! 🎉 Paper link: [OpenReview](https://openreview.net/forum?id=1lK8LPFcXp)
...
Our codebase is built upon [MMVID](https://github.com/snap-research/MMVID), [taming-transformers](https://github.com/CompVis/taming-transformers), [VFIformer](https://github.com/JIA-Lab-research/VFIformer) and [CLIP4IDC](https://github.com/sushizixin/CLIP4IDC). We would like to thank the authors for their excellent open-source contributions.
