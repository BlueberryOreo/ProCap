...
def get_args_base():
    ...
    parser.add_argument(
        '--beit',
        action='store_true',
        help='toggle this to use BEIT model')
    parser.add_argument(
        '--slow',
        action='store_true',
        help=
    ...
    parser.add_argument(
        ...
        default=None,
        help=
        'path to your pretrained space-time transformer model, used for initializing the training'
    )
    
    parser.add_argument('--filtered',
                        action='store_true',
                        help='toggle this to use filtered dataset')
    parser.add_argument('--filter_file_path',
                        type=str,
                        default=None,
    ...
    parser.add_argument('--max_k',
                        type=int,
                        default=0,
                        help='max number of frames to drop')
    parser.add_argument('--sample_strategy',
                        type=str,
                        default='multi-modal',
                        help='sample strategy for filtering, e.g. multi-modal, visual, mixed, random')
    parser.add_argument('--vision_layers',
                        type=int,
                        default=12,
...
def get_args_train():
    ...
    parser.add_argument("--beta_const",
                        default=0.5,
                        type=float,
