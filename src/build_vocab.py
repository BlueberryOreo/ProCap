...
def main():
    ...
    parser.add_argument("--dset_name", type=str, default="anet",
                        choices=["anet", "yc2", "spot", "birds", "edit"])
    ...
    # all_sentences = flat_list_of_lists([v["sentences"] for v in train_data])
    all_sentences = flat_list_of_lists([v["sents"] for v in train_data])
